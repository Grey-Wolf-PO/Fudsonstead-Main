exports.help = {
    ...
    "addcom": ["/addtscom [command], [rank], [output] - adds a custom command to that room which users of specified rank and above can use, and will output the specified phrase."],
